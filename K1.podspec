Pod::Spec.new do |spec|
  ...
  spec.source       = { :git => "https://github.com/yllfejziu/K1.git", :branch => "main", :submodules => true }
  ...
  spec.source_files = 'Sources/secp256k1/libsecp256k1/{src,include,contrib}/*.{h,c}', 'Sources/secp256k1/libsecp256k1/src/modules/{ecdh}/*.{h,c}', 'Sources/K1/**/*.swift'
